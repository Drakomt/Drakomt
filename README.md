...
<img src="assets/field-skills-panel.svg" alt="Field skills mapped to engineering strengths: calm under pressure to production problem solving; route planning to system architecture; crew responsibility to ownership and accountability; clear communication to cross-functional alignment; mission execution to reliable delivery; field discipline to clean engineering habits" width="100%">

<img src="assets/tech-stack-panel.svg" alt="Tech stack. Programming languages: Python, JavaScript, TypeScript, C++, C#, C. Web dev and frameworks: React, Angular, Node.js, .NET Framework, ASP.NET Core, HTML, CSS, Motion, Motion UI. Backend and databases: REST API, MongoDB, MSSQL, Redis, Kafka, Postman. Cloud and DevOps: AWS, Azure, Docker, GitHub, Git, Vercel." width="100%">
...
<img src="assets/signal-stats.svg" alt="Signal stats for Drakomt" width="100%">
...
<img src="dist/github-snake-dark.svg" alt="Contribution route — a year of commit activity for Drakomt, drawn as a trail" width="100%">
